...
(* OASIS_START *)
(* DO NOT EDIT (digest: c7cdcbdf2f39ff7a746b9e36ef8b60cb) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hcarty/proj4ml";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "This library provides access to the PROJ.4 geographic coordinate projection/transformation library (http://trac.osgeo.org/proj/)."
              ];
          tags = [];
          categories = [];
          files_ab = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/hcarty/proj4ml.git";
                      src_repo_browser =
                        Some "https://github.com/hcarty/proj4ml";
     ...
     oasis_digest =
       Some "\011\1661q<\218\153\154\127\148\245\029\147\249(\185";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
